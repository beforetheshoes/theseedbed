...
export type LibraryPageClientProps = {
  initialData?: LibraryPageInitialData;
  initialError?: string;
...
const DEFAULT_PAGINATION: LibraryPagination = {
  page: 1,
  page_size: 25,
  total_count: 0,
  total_pages: 0,
...
const statusTagPt = (value: LibraryItemStatus, isDark: boolean) => ({
  ...
  root: {
    ...
    style: resolveTagColors(STATUS_COLORS[value], isDark),
  },
});

const visibilityTagPt = (value: LibraryItemVisibility, isDark: boolean) => {
...
export default function LibraryPageClient({
  ...
  const didHydrateInitialDataRef = useRef(Boolean(initialData || initialError));
      ...
      >
        <InplaceDisplay>
          <Tag
            ...
            pt={statusTagPt(item.status, isDarkMode)}
            icon="pi pi-bookmark"
            rounded
      ...
      >
        <InplaceDisplay>
          <Tag
            ...
            pt={visibilityTagPt(item.visibility, isDarkMode)}
