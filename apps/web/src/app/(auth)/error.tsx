...
export default function AuthSegmentError({
  ...
  return (
    <Card data-test="auth-segment-error">
      <div className="space-y-4">
        <div>
          <h1 className="text-lg font-semibold">Sign-in page error</h1>
          <p className="mt-1 text-sm text-[var(--p-text-muted-color)]">
            We could not load this auth screen.
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Button
            label="Try again"
            onClick={reset}
            data-test="auth-segment-error-retry"
          />
          <Link
            href="/login"
